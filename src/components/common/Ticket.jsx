...
// import logo from "../../assets/TerracePeaks.png";
// import bg from "../../assets/Snapseed.jpg";

// const Ticket = ({ guestDetails }) => {
...
//               {guestDetails.bookedRooms[0].checkInDate}
//             </p>
//           </div>
...
//               <p className="font-bold ">
//                 Country:{" "}
//                 <span className="font-normal"> {guestDetails?.country}</span>
//               </p>
//               <p className="font-bold ">
//                 State:{" "}
//                 <span className="font-normal"> {guestDetails?.state}</span>
//               </p>
//               <p className="font-bold ">
//                 Zip Code:{" "}
//                 <span className="font-normal"> {guestDetails?.zipCode}</span>
//               </p>
//               <p className="font-bold ">
//                 Guests:
...
//               </h3>
//               <p className="font-bold">
//                 Category: <span className="font-normal">{"Deluxe Room"}</span>
//               </p>
//               <p className="font-bold">
//                 Booked On: <span className="font-normal"> {"1/1/2002"}</span>
//               </p>
//               <p className="font-bold">
//                 Payment mode:{" "}
//                 <span className="font-normal">{"Pay On Spot"}</span>
//               </p>
//               <p className="font-bold">
//                 Payment Status: <span className="font-normal"> {"Unpaid"}</span>
//               </p>
//               <p className="font-bold">
//                 Price to pay : <span className="font-normal">₹{"2000"}</span>
//               </p>
//             </div>
//           </div>
